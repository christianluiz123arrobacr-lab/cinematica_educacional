    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-slate-50 to-red-50">
      ...
      <section className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-slate-200">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded p-6">
              <h4 className="font-bold text-slate-900 mb-3">💡 Aplicação Prática</h4>
              <p className="text-slate-700">
                De óculos a telescópios espaciais, todos dependem da manipulação precisa da luz através de lentes e espelhos curvos.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-slate-200">
          ...
          <div className="space-y-6">
            <div className="bg-green-50 border-l-4 border-green-600 rounded p-6">
              <h3 className="text-2xl font-bold text-slate-900 mb-4">Equações de Lentes</h3>
        ...
        <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl p-8 border border-orange-200">
          ...
          <p className="text-slate-700 mb-4">Aprofunde seus conhecimentos em fenômenos ondulatórios da luz:</p>
