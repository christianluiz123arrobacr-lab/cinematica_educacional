            ...
            <Card className="p-6 md:p-8">
              ...
              <div className="space-y-6">
                <div className="bg-purple-50 p-4 rounded-lg border border-purple-200 overflow-x-auto">
                  <MathFormula formula={String.raw`$$$$\\vec{F} = m \\cdot \\vec{a}$$$$`} className="text-center text-lg md:text-2xl" />
                </div>
            ...
            <Card className="p-6 md:p-8">
              ...
              <div className="space-y-6">
                <div className="bg-cyan-50 p-4 rounded-lg border border-cyan-200 overflow-x-auto">
                  <MathFormula formula={String.raw`$$$$W = F \\cdot d \\cdot \\cos(\\theta)$$$$`} className="text-center text-lg md:text-2xl" />
                </div>
            ...
            <Card className="p-6 md:p-8">
              ...
              <div className="space-y-6">
                <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-200 overflow-x-auto">
                  <MathFormula formula={String.raw`$$$$E_c = \\frac{1}{2} \\cdot m \\cdot v^2$$$$`} className="text-center text-lg md:text-2xl" />
                </div>
            ...
            <Card className="p-6 md:p-8">
              ...
              <div className="space-y-6">
                <div className="bg-pink-50 p-4 rounded-lg border border-pink-200 overflow-x-auto">
                  <MathFormula formula={String.raw`$$$$E_p = m \\cdot g \\cdot h$$$$`} className="text-center text-lg md:text-2xl" />
                </div>
            ...
            <Card className="p-6 md:p-8">
              ...
              <div className="space-y-6">
                <div className="bg-lime-50 p-4 rounded-lg border border-lime-200 overflow-x-auto">
                  <MathFormula formula={String.raw`$$$$\\vec{p} = m \\cdot \\vec{v}$$$$`} className="text-center text-lg md:text-2xl" />
                </div>
            ...
            <Card className="p-6 md:p-8">
              ...
              <div className="space-y-6">
                <div className="bg-sky-50 p-4 rounded-lg border border-sky-200 overflow-x-auto">
                  <MathFormula formula={String.raw`$$$$P = \\frac{W}{\\Delta t}$$$$`} className="text-center text-lg md:text-2xl" />
                </div>
